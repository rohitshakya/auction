...
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        ...
        ?>
            <div class="col mb-5">
                <div class="card h-100">
                    ...
                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="/getProduct?id=<?=$item['id'];?>">View</a></div>
                    </div>
                </div>
            </div>
            <?php
            ...
            echo '<div class="col-md-12 text-center" style="margin-bottom: 180px;"><p>No products available.</p></div>';
        }
        ?>
